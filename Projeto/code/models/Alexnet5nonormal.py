...
def alex_net(_X, _dropout, n_classes, imagesize, img_channel):
    ...
    # Apply Dropout
    norm3 = tf.nn.dropout(pool3, _dropout)
...
for epoch in range(epochs):
    ...
    for i in range(0,vector_training.size,batch_size):
        ...
        step += 1
    if step % 100 == 0:
        saver.save(sess, 'zparametersmodels/savedmodels5class/alexnet/my_modelnormal')
