...
vector_training = np.load('vectors/vector_training4.npy')
...
for epoch in range(epochs):
    for i in range(0,vector_training.size,batch_size):
        ...
        step += 1
    if step % 100 == 0:
        saver.save(sess, 'savedmodels4class/alexnet/my_model2')

vector_test = np.load('vectors/vector_test4.npy')
...
""" for 30 epochs, accuracy gets to 58%
and the confusion matrix is given by
[ 0, 17,  2,  5]
[ 0, 25,  2,  5]
[ 0,  3,  9,  3]
[ 0,  5,  1, 26]

running more 20 epochs we get
48%

running more 66 epochs we get
59.22%

with more 30 epochs we get 64.0777%
...
let's try for more 63 epochs and see what we get
65.0485%
...
""" for the new model after 250 epochs
67.9612%
[ 8, 15,  0,  1]
[ 2, 29,  0,  1]
[ 0,  6,  6,  3]
